...
### SLURM-скрипт для запуска Velvet(все скрипты лежат в папке slurm_scripts)
...
Для сравнения был использован инструмент **QUAST**. Отчёт лежит в assembly_analysis_bck
...
### Сравнение 4 сборок (QUAST Report)
 ...
 итоговая таблица QUAST Отчёт лежит в assembly_analysis_imp
